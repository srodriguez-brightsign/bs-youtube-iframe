...
1. Download the [YouTube.zip](https://github.com/srodriguez-brightsign/bs-youtube-iframe/raw/refs/heads/main/assets/YouTube.zip) file to your computer.
...
4. Expand **Presentation Settings > Support Content > Node.js**.
5. Click the + sign to add a new entry.
6. Under **Node Application Source**, find the `bundle.js` file in the YouTube folder from step 2 above, and click OK.
   - If you use a BSN.Content subscription, you must instead upload a Node.js App to your Network following these steps: https://docs.brightsign.biz/user-guides/content#3s2E5
     ...
     - Click Upload.
   - Then, select the option labeled `bundle` when you reach step 6.
7. Save your changes.
